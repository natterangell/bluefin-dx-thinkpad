...
rpm-ostree override remove clevis clevis-luks --install /tmp/clevis clevis-21-1.tpm1u2.fc40.x86_64.rpm --install /tmp/clevis clevis-luks-21-1.tpm1u2.fc40.x86_64.rpm

# Install thinkfan, tlp, igt-gpu-tools and displaylink kernel module, as well as (temporary) clevis dependencies
rpm-ostree install tlp thinkfan igt-gpu-tools /tmp/rpms/kmods/*evdi*.rpm /tmp/clevis/clevis-dracut-21-1.tpm1u2.fc40.x86_64.rpm clevis-systemd-21-1.tpm1u2.fc40.x86_64.rpm
